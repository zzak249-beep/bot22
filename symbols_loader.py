...
def load_symbols(force: bool = False) -> list:
    ...
    try:
        ...
        for symbol, market in markets.items():
            ...
            # Si no hay datos de volumen, incluir el par de todas formas
            # (mejor tener mas pares que perderse oportunidades)
            if vol_usdt > 0 and vol_usdt < cfg.MIN_VOLUME_USDT:
                continue
